...
#include "ui_qSlicerSSMViewerModuleWidget.h"
...
class qSlicerSSMViewerModuleWidgetPrivate: public Ui_qSlicerSSMViewerModuleWidget
{
public:
  qSlicerSSMViewerModuleWidgetPrivate();
...
//-----------------------------------------------------------------------------
// qSlicerSSMViewerModuleWidgetPrivate methods

//-----------------------------------------------------------------------------
qSlicerSSMViewerModuleWidgetPrivate::qSlicerSSMViewerModuleWidgetPrivate()
{
}

//-----------------------------------------------------------------------------
vtkPolyData* qSlicerSSMViewerModuleWidgetPrivate::convertMeshToVtk(
...
//-----------------------------------------------------------------------------
vtkImageData* qSlicerSSMViewerModuleWidgetPrivate::convertPolyDataToImageData(
...
//-----------------------------------------------------------------------------
// qSlicerSSMViewerModuleWidget methods

//-----------------------------------------------------------------------------
qSlicerSSMViewerModuleWidget::qSlicerSSMViewerModuleWidget(QWidget* _parent)
  : Superclass( _parent )
  , d_ptr( new qSlicerSSMViewerModuleWidgetPrivate )
{
...
//-----------------------------------------------------------------------------
qSlicerSSMViewerModuleWidget::~qSlicerSSMViewerModuleWidget()
{
  Q_D(qSlicerSSMViewerModuleWidget);
...
//-----------------------------------------------------------------------------
void qSlicerSSMViewerModuleWidget::setup()
{
  Q_D(qSlicerSSMViewerModuleWidget);
  d->setupUi(this);
}
...
//-----------------------------------------------------------------------------
void qSlicerSSMViewerModuleWidget::setMRMLScene(vtkMRMLScene* mrmlScene)
{
  this->qSlicerAbstractModuleWidget::setMRMLScene(mrmlScene);
}

//-----------------------------------------------------------------------------
void qSlicerSSMViewerModuleWidget::onSelectInputModel()
{
  Q_D(qSlicerSSMViewerModuleWidget);
...
//-----------------------------------------------------------------------------
void qSlicerSSMViewerModuleWidget::applyModel()
{
  Q_D(qSlicerSSMViewerModuleWidget);
  ...
  /*vtkSlicerSSMViewerLogic* moduleLogic = vtkSlicerSSMViewerLogic::New();
...
//-----------------------------------------------------------------------------
void qSlicerSSMViewerModuleWidget::onSelect()
{
  /**** Display Model ****/
  using std::auto_ptr;
  Q_D(qSlicerSSMViewerModuleWidget);
...
//-----------------------------------------------------------------------------
void qSlicerSSMViewerModuleWidget::displayEigenSpectrum(unsigned int nbPrincipalComponent)
{
  Q_D(qSlicerSSMViewerModuleWidget);
...
//-----------------------------------------------------------------------------
void qSlicerSSMViewerModuleWidget::displayModelVolume(vtkPolyData* modelToDisplay, std::string modelName)
{
  Q_D(qSlicerSSMViewerModuleWidget);

...
{
  return "Module for displaying a Statistical Shape Model (SSM) created with Statismo; a framework for statistical shape modeling<br>";
}

//-----------------------------------------------------------------------------
QString qSlicerSSMViewerModule::acknowledgementText()const
{
  return "This work was funded by the Swiss National Science Foundation (SNSF)";
}
